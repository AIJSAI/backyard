...
They tap a link, or they get an email update, or a photo frame on the shelf shows the week's posts. Each update links to its posts, and replying happens there.
