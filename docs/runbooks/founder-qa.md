...
or reply that has already been deleted never blocks, because its photographs were purged
when it was deleted and nobody can see or restore it. The dry run counts those rows under
