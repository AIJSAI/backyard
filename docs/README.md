...
| **know what is left** | **[OUTSTANDING.md](OUTSTANDING.md)** — the ranked backlog: operator actions, founder decisions, unfixed findings, gate gaps, what the 2026-08-01 readiness audit added on top (§6 — that audit has no separate file), and the full 2026-08-06 session record (§7) |
